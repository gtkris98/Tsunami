    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        private URL createUrl(String stringUrl) {
            ...
            try {
                ...
                Log.e("Soonami", "Error with creating URL", exception);
                return null;
            }
            return url;
        }
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            try {
                ...
                if (urlConnection.getResponseCode() == 200) {
                    ...
                    Log.e("HTTP Response Code" , String.valueOf( urlConnection.getResponseCode()));
                }
            } catch (IOException e) {
        ...
        private Event extractFeatureFromJson(String earthquakeJSON) {
            ...
            try {
                ...
                Log.e("Soonami", "Problem parsing the earthquake JSON results", e);
            }
            return null;
        }
    }
